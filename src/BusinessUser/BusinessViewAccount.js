...
function BusinessViewAccount() {
  ...
  const validate = () => {
    ...
    if (!updatedUser.uen.trim()) {
      newErrors.uen = 'UEN is required';
    } else if (updatedUser.uen.trim().length < 9 || updatedUser.uen.trim().length > 10) {
      newErrors.uen = 'UEN must be 9 or 10 characters long';
    }
  ...
  return (
    <div>
      ...
      <div className="view-account">
        <h2>Your Business User Account</h2>
        {user ? (
          <>
            {isEditing ? (
              <form>
                <table>
                  <tbody>
                    ...
                    <tr>
                      <th>UEN</th>
                      <td>
                        <input type="text" name="uen" value={updatedUser.uen} onChange={handleInputChange} />
                        {errors.uen && <span className="error">{errors.uen}</span>}
                      </td>
                    </tr>
                    <tr>
                      <th>Company Name</th>
...
export default BusinessViewAccount;
