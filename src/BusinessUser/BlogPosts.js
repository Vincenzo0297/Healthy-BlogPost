...
function BlogPosts() {
  ...
  useEffect(() => {
    ...
    const fetchBlogPosts = async () => {
      try {
        const blogPostsCollection = collection(db, 'BlogPost');
        ...
        <div className="search-filter">
            ...
            <div className="sort-select">
                <select value={selectedCategory} onChange={handleCategoryChange}>
                    ...
                    <option value="Fueled">Fueled Naturally</option>
                    <option value="Minimalist">Minimalist Baker</option>
                    <option value="Ela">Ela Vegan</option>
                    <option value=" Emilie"> Emilie Eats</option>
        ...
        <div className="card-grid">
          {filteredPosts.length === 0 ? (
            ...
            filteredPosts.map((post) => (
              <Link to={`/ViewBlogPost/${post.id}`} key={post.id} className="card-link">
                <div className="card">
