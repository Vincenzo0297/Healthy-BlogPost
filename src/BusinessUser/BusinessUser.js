  ...
  return (
    <div>
          ...
          <nav className="nav container">
              ...
              <div className="nav-menu" id="nav-menu">
                  ...
                  <ul className="nav-list">
                      ...
                      <li className="nav-item"><Link to="/BlogPosts" className="nav-link">Blogs</Link></li>
                      ...
                      <li className="nav-item nav-user">
                          ...
                          <ul className="dropdown-menu">
                              <li className="dropdown-item" onClick={() => handleClick('./BusinessViewAccount')}>My Account</li>
      ...
      <section class="experience" id="projects">
          <div class="container">
            <h2 class="section-title padd-15">Business User Tools</h2>
              <div class="experience-items row">
                <div class="experience-item padd-15">
                  <div class="experience-item-inner">
                    ...
                    <h3>Content Post Management</h3>
                    <button className='button-button' onClick={() => handleClick("ContentPost")}>View</button>
                  </div>
                </div>
                ...
                <div class="experience-item padd-15">
                  <div class="experience-item-inner">
                    ...
                    <button className='button-button' onClick={() => handleClick("BlogPost")}>View</button>
                  </div>
                </div>
                ...
                <div class="experience-item padd-15">
                  <div class="experience-item-inner">
                    ...
                    <h3>Recipes Post Management</h3>
                    <button className='button-button' onClick={() => handleClick("RecipesPost")}>View</button>
                  </div>
                </div>
            </div>
          </div>
