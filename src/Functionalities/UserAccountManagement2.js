  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const filteredUserList = userList.filter(user => user.UserType === 'BusinessUser');
      ...
      >
        {selectedUser && (
          <div className="modal-content">
                ...
                <input type="text" value={selectedUser.ContactNumber} readOnly />

                <label>Company Name:</label>
                <input type="text" value={selectedUser.CompanyName} readOnly />

                <label>Company Address:</label>
                <input type="text" value={selectedUser.CompanyAddress} readOnly />

                <label>Postal Code:</label>
                <input type="text" value={selectedUser.PostalCode} readOnly />
